...
Vue.component('text-detection-viz', {
    ...
    <div calss="object-tracking-container">
        ...
        <div class="confidence bg-white/10 backdrop-blur-md text-white p-6 rounded-xl shadow-lg max-w-md mx-auto flex flex-col items-center space-y-4">
            ...
            <span class="confidence-value text-blue-400 font-bold text-sm tracking-wide">
