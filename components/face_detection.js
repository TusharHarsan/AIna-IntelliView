...
Vue.component('face-detection-viz', {
    ...
    <div calss="object-tracking-container">
        ...
        <div class="flex items-center justify-center bg-black">
            ...
            <div class="w-full max-w-md bg-white/10 backdrop-blur-md p-4 rounded-lg shadow-md text-white space-y-2">
                <label for="confidence-range" class="block text-sm font-medium text-blue-300">
                ...
                Current Value: <span class="font-semibold text-blue-400">{{ confidence_threshold }}</span>
                </div>
            </div>
            </div>
