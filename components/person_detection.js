...
Vue.component('person-detection-viz', {
    ...
    <div calss="object-tracking-container">
       ...
       <div class="confidence max-w-md mx-auto bg-white/10 backdrop-blur-md text-white p-6 rounded-lg shadow-md flex flex-col items-center space-y-4">
  
            <span class="text-blue-300 text-base font-medium">
            ...
            <span class="confidence-value text-blue-400 font-semibold">
