  ...
  template: `
    <div calss="object-tracking-container">
       ...
       <div class="flex items-center justify-center bg-black">
            <div class="confidence flex flex-col items-center justify-center bg-white/10 backdrop-blur-md text-white p-6 rounded-xl shadow-lg w-full max-w-md mx-auto">
                    <span class="text-blue-300 font-medium text-sm mb-2">Confidence Threshold</span>
                    ...
                    <span class="confidence-value text-blue-400 font-semibold text-sm">
    ...
    json_data.frames.forEach((frame) => {
      const new_frame = {
        box: {
          ...
          width:
            ((frame.normalized_bounding_box.right || 0) -
              (frame.normalized_bounding_box.left || 0)) *
            video_width,
          height:
            ((frame.normalized_bounding_box.bottom || 0) -
              (frame.normalized_bounding_box.top || 0)) *
            video_height,
        },
